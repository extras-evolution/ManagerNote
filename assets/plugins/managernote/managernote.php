...
if($e->name == 'OnManagerWelcomeHome'){
	...
	<div class="card-body">
			  ...
			  <a onclick="saveNote(); return false" class="btn btn-success" href="" style="cursor: pointer;" id="saveManagerNoteBtn"><i class="fa fa-save"></i> '.$_lang['btn_save'].'</a> <em class="lastTime">'.$lastTime.'</em> </div>
         ');
